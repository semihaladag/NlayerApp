...
namespace Nlayer.Repository.Migrations
{
    ...
    [Migration("20220727112430_inital")]
            ...
            modelBuilder.Entity("Nlayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 27, 14, 24, 30, 140, DateTimeKind.Local).AddTicks(4429),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 27, 14, 24, 30, 140, DateTimeKind.Local).AddTicks(4443),
                            Name = "Kalem 2",
                            Price = 200m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 27, 14, 24, 30, 140, DateTimeKind.Local).AddTicks(4444),
                            Name = "Kalem 3",
                            Price = 600m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 7, 27, 14, 24, 30, 140, DateTimeKind.Local).AddTicks(4445),
                            Name = "Kitap 1",
                            Price = 600m,
                            Stock = 60
                        },
